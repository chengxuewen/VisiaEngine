...
assert.strictEqual(m.abiVersion(), 0x00010009);
...
for (const fn of ['setEntityVisible', 'entityVisible', 'addMesh', 'removeEntity', 'setEventCallback', 'addPoints', 'loadPclBytes', 'setClips', 'getClips', 'loadFont', 'addLabel', 'setMap', 'clearMap', 'navigateClick', 'getCameraPose']) {
